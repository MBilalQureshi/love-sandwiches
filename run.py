...
def calculate_surplus_data(sales_row):
    ...
    # zip method is used to iterate with multiple list at same time
    surplus_data = []
...
def get_last_5_entries_sales():
    ...
    columns = []
    # start from 1 end before 7
    for ind in range(1, 7):
        column = sales.col_values(ind)
        # we used square brackets and -1. This time we want the last 5 items, so we can use -5 here inside our append method.
...
def get_stock_values(data):
    """
    To get remaining stock data along with headings
    """
